...
public class ItemsTickUpdate_1_13 extends ItemsTickUpdate {
	...
	public ItemsTickUpdate_1_13(MagneticItems main) {
		this.main = main;
			...
			if(nearbyEntities != null) {
				...
				for (Entity entity : nearbyEntities) {
					if(entity instanceof Player && !entity.isDead()) {
						...
						if(itemDistanceFromPlayer <= 0.5) continue;
						...
						if(itemPlayerDist != 0) {
							...
							while(iterator.hasNext()) {
								...
								if(bloc.getType() != Material.AIR && !bloc.isPassable()) {
